...
const workbenchBasePlugin = plugin(({ addBase }) => {
  addBase({
    ...
    ':root[data-nomi-color-scheme="dark"], :root[data-mantine-color-scheme="dark"]': {
      'color-scheme': 'dark',
      ...
      '--tc-gen-overlay-bg': 'rgba(255, 255, 255, 0.07)',
      '--tc-gen-overlay-border': 'rgba(255, 255, 255, 0.10)',
      '--tc-gen-overlay-sheen': 'rgba(255, 255, 255, 0.26)',
      '--tc-gen-overlay-body-from': 'rgba(0, 0, 0, 0.36)',
      '--tc-gen-overlay-body-to': 'rgba(0, 0, 0, 0.08)',
      '--tc-gen-overlay-text': 'rgba(255, 255, 255, 0.86)',
    },
    '*': {
    ...
    ':root[data-nomi-color-scheme="dark"] body, :root[data-mantine-color-scheme="dark"] body': {
