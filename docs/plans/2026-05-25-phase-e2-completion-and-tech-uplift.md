...
- Vitest 2 → 3
- 新增 Biome（替代 ESLint+Prettier）

✅ **架构辅助**：
- 持久化层留 SQLite 接口位（不实现，仅暴露抽象给 Phase F 实施）
...
约 **15 个工作日**（3 周），比上一版 spec 多 1 周。原因：
- 统一画布底座 + `NodeRenderKind` 系统是新增工作
- 5 个分类各需自己的节点渲染样式（4 个全新组件）
- 技术栈升级集中在 W0 一次做完

| Wave | 主题 | 工期 |
|---|---|---|
| W0 | 技术栈一次性升级 + 进度 hook + 持久化抽象 | 3 天 |
| W1 | 架构重构：统一画布 + NodeRenderKind + 删 viewType | 3 天 |
| W2 | 5 分类节点渲染组件 | 3 天 |
| W3 | 视觉打磨：composer 内嵌 + Tabler 图标 + 自动编号 + 占位态 + 副本角标 | 3 天 |
...
| W0 | E.2C-03 | Vite 6 | ⏸ | - |
| W0 | E.2C-04 | Vitest 3 | ⏸ | - |
| W0 | E.2C-05 | Biome 替代 ESLint/Prettier | ⏸ | - |
| W0 | E.2C-06 | React 19 | ⏸ | - |
| W0 | E.2C-07 | Zustand 5 | ⏸ | - |
| W0 | E.2C-08 | Tanstack Query 5 替代 SWR | ⏸ | - |
| W0 | E.2C-09 | TipTap 4 | ⏸ | - |
| W0 | E.2C-10 | Electron 33 minor | ⏸ | - |
| W0 | E.2C-11 | 删除 lucide-react | ⏸ | - |
| W0 | E.2C-12 | 持久化层抽象 | ⏸ | - |
